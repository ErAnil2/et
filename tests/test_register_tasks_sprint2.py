"""Verify register/unregister scripts mention the four new task names
and parse cleanly under PowerShell 5.1's Language.Parser."""
import subprocess
...
EXPECTED_NEW_NAMES = [
    "DiscoverIntel_ResolveUrls",
    "DiscoverIntel_MatchOutcomes",
    "DiscoverIntel_TagEntities",
    "DiscoverIntel_ToiGa",
]
